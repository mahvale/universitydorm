      ...
      <div class="container">
        <div class="row no-gutters slider-text d-flex align-itemd-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
          	<div class="text">
	            <p class="breadcrumbs mb-2"><span class="mr-2"><a href="index.html">Chambres</a></span> <span>A propos</span></p>
	        ...
	        <div class="col-lg-9">
		    		<div class="row">
		    			...
		    			<div class="col-sm col-md-6 col-lg-4 ftco-animate" id="rooom">
		    				<div class="room">
		    					<a href="/room/{{$r->id}}" class="img d-flex justify-content-center align-items-center" style="background-image: url(/files/{{$r->photo}});">
		    						<div class="icon d-flex justify-content-center align-items-center">
		    							<span class="icon-search2"></span>
		    						</div>
		    					</a>
		    					<div class="text p-3 text-center">
		    						<h3 class="mb-3"><a href="room/{{$r->id}}">{{$r->name}}</a></h3>
		    						<p><span class="price mr-2">{{$r->prix}}</span> <span class="per">FCFA</span></p>
		    						<ul class="list">
		    							<li><span>Max:</span> {{$r->capacite}} Persons </li>
		    							<li><span>Block:</span> {{ @name_block_chambre($r->id)->name_block}}</li>
		    							<li><span>RESIDENCE:</span> {{ @name_residense_chambre($r->id)->name_residence }}</li>
		    							<li><span>Bed:</span> 1</li>
		    						</ul>
		    						<hr>
		    						<p class="pt-1"><a href="room/{{$r->id}}" class="btn-custom">DETAILS <span class="icon-long-arrow-right"></span></a></p>
		    					</div>
		    				</div>
		    			</div>
		    	...
		    	<div class="col-lg-3 sidebar">
	      		<div class="sidebar-wrap bg-light ftco-animate">
	      			<h3 class="heading mb-4">recherche avancé</h3>
