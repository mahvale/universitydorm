...
<body>
  <div class="container-scroller">
    ...
    <!-- partial -->
    <div class="container-fluid page-body-wrapper" style="position: absolute;left:-13px;">
...
<div id="my-popup" class="mfp-hide white-popup">
  Inline popup
       ...
       <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Listes des reservations </h4>
                  <p class="card-description">
                    Classer  <code>.Par date</code>
                  </p>
                  <div class="table-responsive">
                    <table class="table table-striped">
                      <thead style="font-family: Roboto;text-transform: uppercase;">
                        <tr>
                          <th>
                            #
                          </th>
                      ...
                      <tbody id="tableBody">
                        ...
                        <tr class="" style="cursor:pointer;">
                          ...
                          <td>
                               {{ nbre_residence($r->id) }}  / {{$r->capacite}}
                             <div class="progress">
                              <div class="progress-bar bg-success" role="progressbar" style="width: {{pourcentage(nbre_residence($r->id),$r->capacite)}}%" aria-valuenow="{{pourcentage(nbre_residence($r->id),$r->capacite)}}" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                          </td>
                          <td style="cursor: pointer;">
                           <a href="show_block/{{$r->id}}">{{ count_block($r->id) }}</a> 
                          </td>
                          <td>
                            <a href="show_chambre_residense/{{$r->id}}">{{ count_chambre($r->id) }}</a> 
                          </td>
                           <td>
                            <a href="show_chambre_residense/{{$r->id}}">{{ count_chambre($r->id) }}</a> 
                          </td>
                          <td>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-content">
                                    ...
                                    <a href="#" class="hoverable"  data-id="{{$r->id}}" >Modifier</a>
                                </div>
                            </div>
                        </td>
                        </tr>
...
@include('residence.modal')
@include('residence.modal-img')
@include('residence.modal-detail')
