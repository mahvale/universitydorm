    ...
    <div class="container-fluid page-body-wrapper" style="position: absolute;left: 0px;">
      ...
      <div class="main-panel">
       ...
       <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="card-title text-uppercase ">Listes des chambres </h4>
                        ...
                        <tr class="" style="cursor:pointer;">
                          <td class="py-1">
                             <div class="col-sm-12 col-md ftco-animate">
                                <a href="/files/{{$r->chambre_photo}}" class="insta-img open-popup" style="background-image: url(/files/{{$r->chambre_photo}});">
                                  <div class="icon d-flex justify-content-center">
                                    <img class="" src="/files/{{$r->chambre_photo}}" alt="image"/>
                                  </div>
                                </a>
                              </div>
                          ...
                          <td>
                            {{ name_residence($r->id_residence) }}
                          </td>
                          <td>
                             {{ name_block($r->id_block) }}
                          </td>
                          <td>
                            <div class="dropdown">
                                <button class="dropbtn">⋮</button>
                                <div class="dropdown-content">
                                    <a href="#" class="hoverables"  data-id="{{$r->id_chambre}}">Supprimer</a>
                                    <a href="#" class="hoverable"  data-id="{{$r->id_chambre}}" >Afficher</a>
                                </div>
                            </div>
                        </td>
                        </tr>
...
@include('chambre.modal')
@include('chambre.modal-img')
@include('chambre.modal-detail')
