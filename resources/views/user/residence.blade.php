	    ...
	    <div class="container">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	          ...
	          <li class="nav-item active"><a href="/residences" class="nav-link">Residences</a></li>
      ...
      <div class="container">
        <div class="row no-gutters slider-text d-flex align-itemd-end justify-content-center">
          <div class="col-md-9 ftco-animate text-center d-flex align-items-end justify-content-center">
          	<div class="text">
	            <p class="breadcrumbs mb-2"><span class="mr-2"><a href="">RESIDENCES</a></span> <span>A propos</span></p>
	            <h1 class="mb-4 bread">RESIDENCES</h1>
            </div>
          </div>
        </div>
      </div>
	        ...
	        <div class="col-lg-9">
		    		<div class="row">
		    			...
		    			<div class="col-sm col-md-6 col-lg-4 ftco-animate" id="rooom">
		    				<div class="room">
		    					<a href="/show_block2/{{$r->id}}" class="img d-flex justify-content-center align-items-center" style="background-image: url(/files/{{$r->photo}});">
		    					...
		    					<div class="text p-3 text-center">
		    						...
		    						<ul class="list">
		    							...
		    							<li><span>Block:</span> {{count_block_residence($r->id)}}</li>
		    							<li><span>Chambre:</span> {{count_chambre($r->id)}}</li>
		    							<li><span>Bed:</span> 1</li>
		    						</ul>
		    						<hr>
		    						<p class="pt-1"><a href="/show_block2/{{$r->id}}" class="btn-custom">DETAILS <span class="icon-long-arrow-right"></span></a></p>
		    					</div>
		    				</div>
		    			</div>
