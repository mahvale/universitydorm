      ...
      <div class="inner">
        ...
        <form action="">
          ...
          <div class="row mb-4" style="display: flex;flex-direction: row;">
            <input type="text" class="form-control col-5 mr-1" id="name"  placeholder="Numero">
            <input type="text" class="form-control col-5 ml-1" id="capacite" placeholder="Capacite">
          </div>
          <div class="row">
            <div class="form-holder col-5">
             ...
             <textarea name="message" id="message"  placeholder="Description" class="form-control col-6" style="height: 130px;"></textarea>
          </div>
         
          <button class="BTN" id="valider_block" type="submit" >Valider
